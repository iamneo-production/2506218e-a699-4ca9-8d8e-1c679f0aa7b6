...
useEffect(() => {
    ...
    alert(data.userId)
    const jobs_base_url=`http://localhost:8080/api/user/jobs/${data.userId}`
...
const confirmDeleteJob=()=>{
  console.log(`http://localhost:8080/api/user/jobs/deletejob/${deletejobID}`)
 axios.delete('http://localhost:8080/api/user/jobs/deletejob/'+deletejobID)
  .then(response => {
